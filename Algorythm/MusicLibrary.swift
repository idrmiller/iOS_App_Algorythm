...
struct MusicLibrary {
    ...
    /* Each dictionary is a playlist
        This strategy wouldn;t be used for product quality code, because it is not reusable. You would have to manually enter the dictionary for
        for each playlist. 
    */
